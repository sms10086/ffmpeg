 ...
 */
func Av_buffer_alloc(size int32) *AVBufferRef {
    return (*AVBufferRef)(unsafe.Pointer(C.av_buffer_alloc(C.int(size))))
}
 ...
 * to zero.
 */
func Av_buffer_allocz(size int32) *AVBufferRef {
    return (*AVBufferRef)(unsafe.Pointer(C.av_buffer_allocz(C.int(size))))
}
 ...
 */
func Av_buffer_create(data *uint8, size int32,
 ...
 */
func Av_buffer_pool_init(size int32, alloc func(size int32) **AVBufferRef) *AVBufferPool {
    cb1 := syscall.NewCallbackCDecl(alloc)
    return (*AVBufferPool)(unsafe.Pointer(C.av_buffer_pool_init(C.int(size), 
 ...
 * @return newly created buffer pool on success, NULL on error.
 */
func Av_buffer_pool_init2(size int32, opaque unsafe.Pointer,
                                   alloc func(opaque unsafe.Pointer, size int32) **AVBufferRef,
    ...
    return (*AVBufferPool)(unsafe.Pointer(C.av_buffer_pool_init2(C.int(size), opaque, 
