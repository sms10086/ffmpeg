...
type AVIOContext struct {
    ...
    Bytes_read int64
    Seek_count int32
    Writeout_count int32
    Orig_buffer_size int32
    Short_seek_threshold int32
 ...
 */
func Avpriv_io_move(url_src *byte, url_dst *byte) int32 {
    return int32(C.avpriv_io_move((*C.char)(unsafe.Pointer(url_src)), 
        (*C.char)(unsafe.Pointer(url_dst))))
}
 ...
 * @return >=0 on success or negative on error.
 */
func Avpriv_io_delete(url *byte) int32 {
    return int32(C.avpriv_io_delete((*C.char)(unsafe.Pointer(url))))
}
