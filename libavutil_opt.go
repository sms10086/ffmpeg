 ...
 */
func Av_opt_child_class_next(parent *AVClass, prev *AVClass) *AVClass {
    return (*AVClass)(unsafe.Pointer(C.av_opt_child_class_next(
        (*C.AVClass)(unsafe.Pointer(parent)), (*C.AVClass)(unsafe.Pointer(prev)))))
}
...
func Av_opt_set_channel_layout(obj unsafe.Pointer, name *byte, ch_layout int64, search_flags int32) int32 {
    return int32(C.av_opt_set_channel_layout(obj, 
        (*C.char)(unsafe.Pointer(name)), C.longlong(ch_layout), 
        C.int(search_flags)))
}
/**
...
func Av_opt_get_channel_layout(obj unsafe.Pointer, name *byte, search_flags int32, ch_layout *int64) int32 {
    return int32(C.av_opt_get_channel_layout(obj, 
        (*C.char)(unsafe.Pointer(name)), C.int(search_flags), 
        (*C.longlong)(unsafe.Pointer(ch_layout))))
}
/**
